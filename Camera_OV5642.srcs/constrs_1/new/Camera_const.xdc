...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {i_Switch_3}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {i_Switch_3}]
#set_property PACKAGE_PIN V16 [get_ports {i_Switch_4}]					
...
#set_property PACKAGE_PIN T1 [get_ports {i_Switch_2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {i_Switch_2}]
#set_property PACKAGE_PIN R2 [get_ports {i_Switch_1}]					
...
#set_property PACKAGE_PIN U14 [get_ports {cnt[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cnt[6]}]
#set_property PACKAGE_PIN V14 [get_ports {cnt[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cnt[7]}]
#set_property PACKAGE_PIN V13 [get_ports {cnt[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cnt[8]}]
#set_property PACKAGE_PIN V3 [get_ports {cnt[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cnt[9]}]
#set_property PACKAGE_PIN W3 [get_ports {cnt[10]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cnt[10]}]
#set_property PACKAGE_PIN U3 [get_ports {cnt[11]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cnt[11]}]
#set_property PACKAGE_PIN P3 [get_ports {cnt[12]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cnt[12]}]
#set_property PACKAGE_PIN N3 [get_ports {cnt[13]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cnt[13]}]
#set_property PACKAGE_PIN P1 [get_ports {cnt[14]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cnt[14]}]
#set_property PACKAGE_PIN L1 [get_ports {cnt[15]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cnt[15]}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports butt_in]						
	set_property IOSTANDARD LVCMOS33 [get_ports butt_in]
#set_property PACKAGE_PIN T18 [get_ports i_Button_Start]						
#	set_property IOSTANDARD LVCMOS33 [get_ports i_Button_Start]
...
#set_property PACKAGE_PIN U17 [get_ports i_Button_4]						
#	set_property IOSTANDARD LVCMOS33 [get_ports i_Button_4]
